...
const request = {
  ...
  query: {
    text: 'How do you ensure your work actively builds sustainable in-house capability and enables our existing teams (Engineering Product) through coaching and knowledge transfer, rather than creating a long-term dependency on their firm?',
  },
  pageSize: 10,
